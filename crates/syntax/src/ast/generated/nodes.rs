...
impl AsmDirSpec {
    ...
    pub fn inout_token(&self) -> Option<SyntaxToken> {
        support::token(&self.syntax, T![inout])
    }
    #[inline]
    pub fn lateout_token(&self) -> Option<SyntaxToken> {
        support::token(&self.syntax, T![lateout])
    }
    #[inline]
...
impl AsmExpr {
    #[inline]
    pub fn asm_pieces(&self) -> AstChildren<AsmPiece> {
        support::children(&self.syntax)
    }
    #[inline]
    pub fn template(&self) -> AstChildren<Expr> {
        support::children(&self.syntax)
    }
    #[inline]
...
impl AsmLabel {
    ...
    pub fn label_token(&self) -> Option<SyntaxToken> {
        support::token(&self.syntax, T![label])
    }
}
...
impl AsmOperandExpr {
    ...
    #[inline]
    pub fn out_expr(&self) -> Option<Expr> {
        support::child(&self.syntax)
    }
    #[inline]
...
impl AsmOperandNamed {
    #[inline]
    pub fn asm_operand(&self) -> Option<AsmOperand> {
        support::child(&self.syntax)
    }
    #[inline]
...
impl AsmOption {
    ...
    #[inline]
    pub fn nomem_token(&self) -> Option<SyntaxToken> {
        support::token(&self.syntax, T![nomem])
    }
    #[inline]
    ...
    #[inline]
    pub fn nostack_token(&self) -> Option<SyntaxToken> {
        support::token(&self.syntax, T![nostack])
    }
    #[inline]
...
impl AsmOptions {
    #[inline]
    pub fn asm_options(&self) -> AstChildren<AsmOption> {
        support::children(&self.syntax)
    }
    #[inline]
    pub fn l_paren_token(&self) -> Option<SyntaxToken> {
...
impl AsmRegOperand {
    #[inline]
    pub fn asm_dir_spec(&self) -> Option<AsmDirSpec> {
        support::child(&self.syntax)
    }
    #[inline]
    pub fn asm_operand_expr(&self) -> Option<AsmOperandExpr> {
        support::child(&self.syntax)
    }
    #[inline]
    pub fn asm_reg_spec(&self) -> Option<AsmRegSpec> {
        support::child(&self.syntax)
    }
    #[inline]
    pub fn l_paren_token(&self) -> Option<SyntaxToken> {
...
impl AsmSym {
    ...
    #[inline]
    pub fn sym_token(&self) -> Option<SyntaxToken> {
        support::token(&self.syntax, T![sym])
    }
}
...
impl AssocTypeArg {
    ...
    #[inline]
    pub fn return_type_syntax(&self) -> Option<ReturnTypeSyntax> {
        support::child(&self.syntax)
    }
    #[inline]
    pub fn ty(&self) -> Option<Type> {
...
impl ClosureExpr {
    #[inline]
    pub fn for_binder(&self) -> Option<ForBinder> {
        support::child(&self.syntax)
    }
    #[inline]
    pub fn param_list(&self) -> Option<ParamList> {
...
impl Fn {
    ...
    pub fn safe_token(&self) -> Option<SyntaxToken> {
        support::token(&self.syntax, T![safe])
    }
    #[inline]
    pub fn unsafe_token(&self) -> Option<SyntaxToken> {
        support::token(&self.syntax, T![unsafe])
...
impl PathSegment {
    ...
    #[inline]
    pub fn type_anchor(&self) -> Option<TypeAnchor> {
        support::child(&self.syntax)
    }
    #[inline]
    pub fn coloncolon_token(&self) -> Option<SyntaxToken> {
...
impl From<CallExpr> for AnyHasArgList {
    ...
    fn from(node: CallExpr) -> AnyHasArgList {
        AnyHasArgList { syntax: node.syntax }
    }
}
...
impl From<AssocTypeArg> for AnyHasGenericArgs {
    ...
    fn from(node: AssocTypeArg) -> AnyHasGenericArgs {
        AnyHasGenericArgs { syntax: node.syntax }
    }
}
...
impl From<ItemList> for AnyHasModuleItem {
    ...
    fn from(node: ItemList) -> AnyHasModuleItem {
        AnyHasModuleItem { syntax: node.syntax }
    }
}
...
impl From<AssocTypeArg> for AnyHasTypeBounds {
    ...
    fn from(node: AssocTypeArg) -> AnyHasTypeBounds {
        AnyHasTypeBounds { syntax: node.syntax }
    }
}
